...
//      */
//     public void TestCase02(RemoteWebDriver driver) throws InterruptedException {
//         Boolean status;
...
//         registration.navigateToRegisterPage();
//         status = registration.registerUser("testUser", "abc@123", true);
//         Assert.assertTrue("Unble to perfrom Registration", status);
...
//         Assert.assertTrue("Re-registration successful :", status);
